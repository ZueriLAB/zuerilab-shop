      ...
      <main className="legal-page">
        ...
        <section>
          ...
          <p>
            ...
            für In-vitro-Labor- und wissenschaftliche Forschungszwecke bestimmt.
          </p>

          <p>
            Sie sind nicht für den menschlichen oder tiermedizinischen Verzehr,
            therapeutische Anwendungen, klinische Anwendungen oder andere
            nicht-wissenschaftliche Zwecke bestimmt.
          </p>

          <p>Mit dem Kauf über diese Website bestätigen Sie, dass:</p>
          ...
          <ul>
            ...
            <li>
              Sie alle erworbenen Produkte ausschließlich für rechtmäßige und
              nicht-klinische Forschungszwecke verwenden.
            </li>

            <li>
              Sie die Produkte nicht weiterverkaufen, weiterverteilen oder
              anderen Personen zur Anwendung am Menschen oder an Tieren zur
              Verfügung stellen.
            </li>
        ...
        <section>
          ...
          <p>
            Der Zugang zu dieser Website sowie der Kauf von Produkten ist auf
            verifizierte Forscher und Fachpersonen beschränkt.
          </p>

          <p>
            Wir behalten uns das Recht vor, Bestellungen nach eigenem Ermessen
            abzulehnen oder zu stornieren, insbesondere wenn Grund zu der
            Annahme besteht, dass die Produkte nicht für legitime
        ...
        <section>
          ...
          <p>
            Bestellungen, die an Werktagen vor 14:00 Uhr CET eingehen, werden
            in der Regel noch am selben Tag versendet.
          </p>

          <p>
            Wir versenden aus der Schweiz und bieten internationalen Versand an.
            Die Lieferzeiten können je nach Zielland variieren.
          </p>

          <p>
            Der Kunde ist selbst dafür verantwortlich, sicherzustellen, dass
            die Einfuhr der bestellten Produkte in seinem jeweiligen Land
        ...
        <section>
          ...
          <p>
            Aufgrund der besonderen Beschaffenheit unserer Forschungsprodukte
            akzeptieren wir keine Rücksendungen geöffneter oder bereits
        ...
        <section>
          ...
          <p>
            Soweit nach Schweizer Recht zulässig, haftet SwissPharmaLab nicht
            für indirekte, zufällige, besondere oder Folgeschäden, die aus der
            Verwendung oder der Unmöglichkeit der Verwendung unserer Produkte
            entstehen.
          </p>

          <p>
            Die Gesamthaftung von SwissPharmaLab ist auf den Betrag begrenzt,
            der für die konkrete Bestellung bezahlt wurde, aus der der jeweilige
        ...
        <section>
          ...
          <p>
            ...
            Allgemeinen Geschäftsbedingungen ist, soweit gesetzlich zulässig,
            die Zuständigkeit der Gerichte in Zürich, Schweiz, vereinbart.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Durch die weitere Nutzung der Website nach einer Änderung erklären
            Sie sich mit der aktualisierten Version der Allgemeinen
